...
class ChatbotServiceTest {
    ...
    void ask_combinesEvidenceAndAnswer() {
        ChatbotService service = new ChatbotService(evidenceRetriever, answerGenerator);
        ...
        when(answerGenerator.generate("레디스 키?")).thenReturn("근거 기반 답변");

        ChatResponse response = service.ask("레디스 키?");
    ...
    void ask_returnsErrorResponse() {
        ...
        ChatResponse response = service.ask("질문");
