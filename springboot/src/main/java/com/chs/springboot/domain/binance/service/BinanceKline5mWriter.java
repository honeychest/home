...
/** binance_kline_5m 전용 add-only 저장기. 기존 운영 테이블은 절대 건드리지 않는다. */
@Component
public class BinanceKline5mWriter {

    private static final String INSERT_SQL = """
            INSERT IGNORE INTO binance_kline_5m
    ...
    public BinanceKline5mWriter(JdbcTemplate batchJdbcTemplate) {
