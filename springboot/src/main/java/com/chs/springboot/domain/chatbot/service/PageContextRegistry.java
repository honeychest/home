...
public class PageContextRegistry {
     ...
     * pathPrefixes: 이 페이지에 속하는 소스 경로 프리픽스(정규화된 '/' 기준). 검색 시 pageId 소프트 가중에 사용.
     */
    public record PageInfo(String label, String promptHint, String searchTerms, List<String> pathPrefixes) {
    }
